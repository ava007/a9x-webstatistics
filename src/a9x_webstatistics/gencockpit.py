...
def runGenCockpit(infile, outfile, domain):
    with open(infile) as json_file:
        ...
        h += ' data: { ' + "\n" 
        h += '   datasets: [' + "\n"
        h += '     { type: \'bar\', label: \'Desktop\', data: ' + str(day_dta_desktop) + ',backgroundColor: \'#42c5f5\'},yAxisID: \'bar-y-axis\'' + "\n"
        h += '    ,{ type: \'bar\', label: \'Mobile\',  data: ' + str(day_dta_mobile) + ',backgroundColor: \'#42f5aa\'},yAxisID: \'bar-y-axis\'' + "\n"
        h += '    ,{ type: \'bar\', label: \'Tablets\', data: ' + str(day_dta_tablet) + ',backgroundColor: \'#f5a742\'},yAxisID: \'bar-y-axis\'' + "\n"
