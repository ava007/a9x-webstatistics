    ...
    if ('response_time' in i 
        ...
        if tmp_rtime > 0:
            ...
            if 'topFast' not in d['v0001']['days'][dt]['performance']:
                ...
                d['v0001']['days'][dt]['performance']['topFast'][req.path] = tmp_rtime  # only path, no query params
            else:
                max_value = float(max(d['v0001']['days'][dt]['performance']['topFast'].values()))  # maximum value
                if tmp_rtime  < max_value:
                    d['v0001']['days'][dt]['performance']['topFast'][req.path] = tmp_rtime
            ...
            if 'topSlow' not in d['v0001']['days'][dt]['performance']:
                ...
                d['v0001']['days'][dt]['performance']['topSlow'][req.path] = tmp_rtime
            else:
