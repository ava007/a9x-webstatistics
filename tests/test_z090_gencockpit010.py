...
#from a9x_webstatistics.gencockpitsubV0001 import cockpitlanguage
...
class TestGencockpit010(unittest.TestCase):
    ...
    def test_gencockpit010(self):
        ...
        assert runGenCockpitV0001(infile="webstat.json",outfile="webstat.html",domain="https://logikfabrik.com", omit='') == 0
